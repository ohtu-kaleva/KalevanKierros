Rails.application.routes.draw do
  ...
  get 'results/female_groups', to: 'results#with_female_group', as: 'results_for_female_groups'
  get 'results/mixed_groups', to: 'results#with_mixed_group', as: 'results_for_mixed_groups'
